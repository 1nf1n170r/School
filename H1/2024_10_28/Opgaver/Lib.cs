...
namespace Lib
{
    ...
    public static class Input
    {
        ...
        public static T AskReg<T>(string question, Regex pattern, bool newline, ConsoleColor quColor = ConsoleColor.DarkBlue, ConsoleColor ansColor = ConsoleColor.Green, ConsoleColor errorColor = ConsoleColor.Red)
        {
